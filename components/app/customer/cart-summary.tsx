...
const CartSummary = (props: CartSummaryProps) => {
  return (
    <View
      style={[
        combineStyles(GlobalStyles, "background_softer_blue"),
        { flex: 1 },
      ]}
    >
      <ScrollView>
        ...
        >
          ...
          >
            <Text
              style={combineStyles(GlobalStyles, "color_white", "font_bold")}
            >
        ...
        {props.relatedItems?.length ? (
          <View style={combineStyles(GlobalStyles, "margin_sm")}>
            <Text
              style={combineStyles(GlobalStyles, "text_2xl", "margin_b_sm")}
            >
              You Might Also Like
            </Text>
            <FlatList
